...
namespace API.Tests
{
    public class PasswordPolicyTests : PasswordPolicy
    {
        ...
        public void Scenario074_GetPasswordPolicy()
        {
            HttpStatusCode expectedStatusCode = HttpStatusCode.OK;
            HttpStatusCode actualStatusCode;
            
            IRestResponse restResponse = GetPasswordPolicy();

            var passwordPolicy = PasswordPolicy.FromJson(restResponse.Content);
